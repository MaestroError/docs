...
<CardGroup cols={3}>
  ...
  <Card title="Tool Classes" icon="puzzle-piece" href="/v1/tools/tool-classes">
    Create dedicated reusable tool classes — perfect for complex or shared tools.
  </Card>
  <Card title="Inline Tools" icon="code" href="/v1/tools/inline-tools">
    Build tools programmatically at runtime — ideal for dynamic, context-dependent tools.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Tool Classes" icon="puzzle-piece" href="/v1/tools/tool-classes">
    Build reusable tool classes for complex functionality.
  </Card>
  <Card title="Inline Tools" icon="code" href="/v1/tools/inline-tools">
