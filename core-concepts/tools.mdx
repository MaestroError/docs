...
<Tip>
`setCallback` method accepts any [php callable](https://www.php.net/manual/en/language.types.callable.php), such as a function name, a closure, or a class method.
</Tip>
...
<Icon icon="x" iconType="solid" color="red" /> **Don't** create tools with ambiguous functionality or unclear parameter requirements

<Icon icon="x" iconType="solid" color="red" /> **Don't** expose sensitive operations without proper validation and security checks
