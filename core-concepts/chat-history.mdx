...
<Icon icon="x" iconType="solid" color="red" />  **Don't** store sensitive information in chat histories without proper encryption

<Icon icon="x" iconType="solid" color="red" />  **Don't** neglect to clear chat histories when they're no longer needed
