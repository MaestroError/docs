...
<CardGroup cols={2}>
  ...
  <Card title="GroqDriver" icon="twitter">
    Works with Groq platform API, add `GROQ_API_KEY` to your `.env` file and use "groq" provider in your agents
  </Card>
  <Card title="OllamaDriver" icon="meta">
    Works with Ollama platform API, use "ollama" provider in your agents and any models you have installed with Ollama
  </Card>
</CardGroup>
